        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4 text-slate-400">
              <Link href="https://wa.me/250792529538" className="hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" /></svg>
                <span className="sr-only">WhatsApp</span>
              </Link>
              <Link href="https://linkedin.com/in/m-i-christella" className="hover:text-primary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
                <span className="sr-only">LinkedIn</span>
              </Link>
              <Link href="https://github.com/Chiki-tella" className="hover:text-primary transition-colors">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="flex flex-col gap-3 text-sm text-slate-400">
              <li>Sales: <a href="mailto:christellamunezeroimpano@gmail.com" className="hover:text-primary transition-colors">christellamunezeroimpano@gmail.com</a></li>
              <li>Support: <a href="mailto:support@auditai.com" className="hover:text-primary transition-colors">support@auditai.com</a></li>
              <li className="mt-4">
                <p className="text-xs text-slate-500">123 Market St. Suite 400<br />San Francisco, CA 94103</p>
              </li>
            </ul>
          </div>
        </div>
